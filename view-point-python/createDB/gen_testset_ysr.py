...
def create_testbed(db_path, dump_path):
    ...
    img_list_train, img_list_test, idx_train, idx_test, geo_list_train, geo_list_test, env_list_train, env_list_test, a_score_train, a_score_test = train_test_split(img_list, idx, geo_list, env_list, a_score, test_size=0.1, random_state=42)
