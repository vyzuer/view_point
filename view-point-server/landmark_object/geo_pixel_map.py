...
def dump_geo_pixel_map(geo_list, a_score, e_lat, e_lon, num_xstep, num_ystep, dump_dir, dump_map):
...
def find_geo_pixel_map_human(dump_path, model_path, e_lat, e_lon, num_xstep, num_ystep, dump_map, ext='geo_pixel_map'):
    ...
    dump_geo_pixel_map(geo_list, a_score, e_lat, e_lon, num_xstep, num_ystep, dump_dir, dump_map)
